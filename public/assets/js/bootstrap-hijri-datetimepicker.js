...
(function (factory) {
    ...
    var flatpickr = function (element, options) {
    ...
    $.fn.flatpickr = function (options) {
        return this.each(function () {
            ...
            if (!$this.data('flatpickr')) {
                ...
                options = $.extend(true, {}, $.fn.flatpickr.defaults, options);
                $this.data('flatpickr', flatpickr($this, options));
            }
        });
    };

    $.fn.flatpickr.defaults = {
        timeZone: 'Etc/UTC',
        format: 'DD-MM-YYYY',
