        ...
        <div class="container d-flex flex-column flex-lg-row" id="kt_docs_content_container">
            ...
            <div class="card card-docs flex-row-fluid mb-2">
                ...
                <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                    ...
                    <div class="py-0">
                        <!--begin::Heading-->
                        <h1 class="fw-bold mb-5">{{__('Manage Coupon')}}</h1>
                                        ...
                                        <table class="table align-middle border rounded table-row-dashed fs-6 g-5" id="kt_datatable_example">
                                            <thead>
                                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase">
                                                    ...
                                                    <th class="min-w-100px"> {{__('Discount (%)')}}</th>
                                                    <th class="min-w-100px"> {{__('Limit')}}</th>
                                                    <th class="min-w-100px"> {{__('Used')}}</th>
                                                ...
                                                @foreach ($coupons as $coupon)
                                                    <tr>
                                                        ...
                                                        <td class="Action text-center">
                                                            <span>
                                                                @can('edit coupon')
                                                                    <a href="#" class="btn btn-icon btn-active-light-success w-30px h-30px" data-url="{{ route('coupons.edit',$coupon->id) }}" data-size="lg" data-ajax-popup="true" data-title="{{__('Edit Structure')}}" data-toggle="tooltip" data-original-title="{{__('Edit')}}"><i class="fa fa-edit"></i></a>
                                                                    <a href="{{ route('coupons.show',$coupon->id) }}" class="btn btn-icon btn-active-light-info w-30px h-30px"><i class="fa fa-eye"></i></a>
                                                                @endcan
                                                                @can('delete coupon')
                                                                    <button type="button" class="btn btn-icon confirm-delete btn-active-light-danger w-30px h-30px" data-toggle="tooltip" ><i class="fa fa-trash"></i></button>
