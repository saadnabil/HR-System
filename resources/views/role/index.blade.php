                    ...
                    <div class="py-0">
                        ...
                        <div class="all-button-box row d-flex justify-content-end">
                                <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                                    <a href="#" data-url="{{ route('roles.create') }}" data-size="xl" data-ajax-popup="true" data-title="{{__('Create New Company')}}" class="btn btn-primary btn-icon-only width-auto">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="Permission">
                                                            @foreach($role->permissions()->pluck('name') as $permission)
                                                                <a class="badge badge-light-success fs-7 m-1" href="#" class="absent-btn">{{$permission}}</a>
                                                            @endforeach
                                                        </td>
                                                        <td class="Action text-center">
                                                            <span>
                                                         
                                                                    <a href="#" class="btn btn-icon btn-active-light-success w-30px h-30px" data-url="{{ URL::to('roles/'.$role->id.'/edit') }}" data-size="lg" data-ajax-popup="true" title="{{__('Edit Role')}}" data-toggle="tooltip"><i class="fa fa-edit"></i></a>
