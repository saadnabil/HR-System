            ...
            <form id="updateAvatar" action="{{ route('avatar.update') }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="app-modal-body">
                    ...
                    @if(!empty(auth()->user()->avatar))
                        <div class="avatar av-l upload-avatar-preview" style="background-image: url('{{ asset('/storage/uploads/'.config('chatify.user_avatar.folder').'/'.auth()->user()->avatar) }}');"></div>
                    @else
                        <div class="avatar av-l upload-avatar-preview" style="background-image: url('{{ asset('/storage/uploads/'.config('chatify.user_avatar.folder').'/avatar.png') }}');"></div>
                    @endif
