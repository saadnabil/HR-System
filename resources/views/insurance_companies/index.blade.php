    ...
    <div class="all-button-box row d-flex justify-content-end">
        @can('Create Employee')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" data-url="{{ route('insurance-companies.create' , ['parent' => request()->get('id')]) }}" class="btn btn-primary" data-ajax-popup="true" data-title="{{__('Create New')}}">
    ...
    <div class="container d-flex flex-column flex-lg-row" id="kt_docs_content_container">
        ...
        <div class="card card-docs flex-row-fluid mb-2">
            ...
            <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                ...
                <div class="py-0">
                    <!--begin::Heading-->
                    <h1 class="fw-bold mb-5">{{__('Insurance companies')}}</h1>

                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        <!--begin::Primary button-->

                        <a href="#" data-url="{{ route('insurance-companies.create') }}" data-ajax-popup="true"
                                            ...
                                            @foreach ($companies as $company)
                                                <tr>
                                                    ...
                                                    <td class="Action text-center">
                                                        <span>
                                                                <a href="#" class="btn btn-icon btn-active-light-success w-30px h-30px" data-url="{{ route('insurance-companies.edit', $company->id) }}" data-size="lg" data-ajax-popup="true" data-title="{{ __('Edit') }}" data-toggle="tooltip" data-original-title="{{__('Edit')}}"><i class="fa fa-edit"></i></a>
                                                                ...
                                                                {!! Form::open(['method' => 'DELETE', 'route' => ['insurance-companies.destroy', $company->id],'id'=>'delete-form-'.$company->id]) !!}
                                                                {!! Form::close() !!}
                                                        </span>
                                                    </td>
                                                </tr>
