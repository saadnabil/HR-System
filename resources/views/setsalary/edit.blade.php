                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-4">
                                        <div class="form-group">
                                            {{ Form::label('allowance_option', __('Allowance Options*'),['class' => 'd-flex align-items-center fs-6 fw-semibold mb-2']) }}
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="form-group">
                                            {{ Form::label('title', __('Title_ar'),['class' => 'd-flex align-items-center fs-6 fw-semibold mb-2']) }}
