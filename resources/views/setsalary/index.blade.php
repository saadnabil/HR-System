                                            ...
                                            @foreach ($employees as $employee)
                                                <tr>
                                                    ...
                                                    <td class="Action text-center">
                                                        <span>
                                                            @can('Edit Employee')
                                                                <a href="{{route('setsalary.show',$employee->id)}}" class="btn btn-icon btn-active-light-info w-30px h-30px" data-title="{{ __('View') }}" data-toggle="tooltip" data-original-title="{{__('View')}}"><i class="fa fa-eye"></i></a>
                                                            @endcan
                                                        </span>
                                                    </td>
                                                </tr>
