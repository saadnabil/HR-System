    ...
    <div class="container d-flex flex-column flex-lg-row" id="kt_docs_content_container">
        ...
        <div class="card card-docs flex-row-fluid mb-2">
            ...
            <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                ...
                <div class="py-0">
                    <!--begin::Heading-->
                    <h1 class="fw-bold mb-5">{{__('Manage Department')}}</h1>
                            ...
                            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                ...
                                <div class="card-title">
                                    ...
                                    <div class="d-flex align-items-center position-relative my-1">
                                        ...
                                        <!--end::Svg Icon-->
                                        <input type="text" data-kt-filter="search" class="form-control form-control-solid w-250px ps-14" bankholder="{{__('Search')}}">
                                    </div>
                                    <!--end::Search-->
                                </div>
                                <!--end::Card title-->
                                ...
                                <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                    ...
                                    <button type="button" class="btn btn-primary" data-kt-menu-trigger="click" data-kt-menu-bankment="bottom-end">
                                    ...
                                    <table class="table align-middle border rounded table-row-dashed fs-6 g-5" id="kt_datatable_example">
                                        <thead>
                                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase">
                                                ...
                                                <th class="min-w-100px">{{__('Department Manager')}}</th>
                                        ...
                                        <tbody class="fw-semibold text-gray-600">
                                            @foreach ($departments as $dept)
                                                <tr>
                                                    <td>{{ !empty($dept->branch)?$dept->branch->name:'' }}</td>
                                                    <td>{{ $dept->name }}</td>
                                                    @if (!$dept->manager)
                                                        <td>-</td>
                                                    @else
                                                        ...
                                                        @else
                                                            <td>{{ $dept->manager->name_ar }}</td>
                                                        @endif
                                                    @endif
                                                    <td class="Action text-center">
                                                        <span>
                                                            @can('Edit Department')
                                                                <a href="#" class="btn btn-icon btn-active-light-success w-30px h-30px" data-url="{{ URL::to('department/'.$dept->id.'/edit') }}" data-size="lg" data-ajax-popup="true" data-title="{{ __('Edit') }}" data-toggle="tooltip" data-original-title="{{__('Edit')}}"><i class="fa fa-edit"></i></a>
                                                            @endcan
                                                            @can('Delete Department')
                                                                <button type="button" data-id="{{$dept->id}}" class="btn btn-icon confirm-delete btn-active-light-danger w-30px h-30px" data-toggle="tooltip" data-original-title="{{__('Delete')}}" ><i class="fa fa-trash"></i></button>
                                                                {!! Form::open(['method' => 'DELETE', 'route' => ['department.destroy', $dept->id],'id'=>'delete-form-'.$dept->id]) !!}
                                                                {!! Form::close() !!}
                                                            @endcan
                                                        </span>
                                                    </td>
