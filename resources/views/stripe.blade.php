                    ...
                    var x = getpaidSetup({
                        ...
                        callback: function (response) {
                            ...
                            if (
                                ...
                                window.location.href = flutter_callback + '/' + txref + '/' + '{{($plan->id)}}?coupon_id=' + coupon_id;
                            } else {
                ...
                if (res.flag == 1) {
                    ...
                    var options = {
                        ...
                        "handler": function (response) {
                            window.location.href = razorPay_callback + '/' + response.razorpay_payment_id + '/' + '{{($plan->id)}}?coupon_id=' + coupon_id;
                        },
                        "theme": {
                            "color": "#528FF0"
                        }
