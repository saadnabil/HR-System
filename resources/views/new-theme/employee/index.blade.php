        ...
        <div class="pageS1">
            <div class='sectionS2'>
                <div class="head withBorder flex align between">
                    <h3 class='small'>{{ __('All Employees') }}</h3>
                    <div class='flex align gap-3 options'>

                        @can('Employee-Print')
                            <button class='buttonS2  withBorder' onclick="printDiv()">
                ...
                <div class="tableS1 scroll trPointer" id="tablePrint">
                    ...
                    <table>
                        ...
                        <tbody>
                            @include('new-theme.employee.employees')
                        </tbody>
                    </table>
                </div>
            </div>
            ...
            <div class="paginater">
                @include('new-theme.employee.paginate')
            </div>
        </div>
    </div>
@endsection
