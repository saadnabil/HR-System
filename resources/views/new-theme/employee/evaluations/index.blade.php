                                ...
                                <div class='datePicker'>
                                    ...
                                    <div class="inputS1 noHeight">
                                        ...
                                        <input style="width: 225px;" type="text" value=""
                                            placeholder="{{__("Start Date")}}" name="daterange" class="datePickerBasic"
                                            autocomplete="off" />
                                    </div>
                                </div>
                                <div class='datePicker '>
                                    ...
                                    <div class="inputS1 noHeight">
                                        <img src="/new-theme/icons/date.svg" class="iconImg" />
                                        <input style="width: 225px;" type="text" value=""placeholder="{{__("End Date")}}" name="daterange" class="datePickerBasic" autocomplete="off" />
                                    </div>
                                </div>
                            </div>
                        </div>
