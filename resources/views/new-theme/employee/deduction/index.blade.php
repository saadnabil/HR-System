        ...
        <div class="pageS1">
            ...
            <div class='sectionS2'>
                <div class="head withBorder flex align between options">
                    <h3 class='small'>{{ __('All Deductions') }}</h3>
                    <div class='flex align gap-3 options'>

                        @can('Saturationdeduction-Print')
                        ...
                        @can('Saturationdeduction-Export')
                        <a href="{{ Route('deduction.export') }}">
                            <button class='buttonS2 withBorder'>
                                <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        @can('Saturationdeduction-Create')
                            <a href='{{ Route('saturationdeduction.create') }}'>
                    ...
                    <div class='datePickerContainer'>
                        <div class='datePicker'>
                            ...
                            <div class="inputS1">
                                ...
                                <input style="width: 225px;" type="text" value=""
                                    placeholder="{{ __('Start Date') }}" name="daterange" id="start_date"
                        ...
                        <div class="datePicker">
                            ...
                            <div class="inputS1">
                                <img src="/new-theme/icons/date.svg" class="iconImg" />
                                <input style="width: 225px;" type="text" value=""
                                    placeholder="{{ __('End Date') }}" name="daterange" id="end_date"
                                    class="datePickerBasic" autocomplete="off" />
                            </div>
                        </div>
                    </div>
                ...
                <div class="tableS1 scroll trPointer">
                    <table>
                        ...
                        <tbody>
                            @include('new-theme.employee.deduction.deduction')
                        </tbody>
                    </table>
                </div>
            </div>
            ...
            <div class="paginater flex gap-4 align">
                @include('new-theme.employee.deduction.paginate')
            </div>
    ...
    <script>
        $(document).ready(function() {
            function fetch_data(query, start_date, end_date) {
                $.ajax({
                    url: "{{ route('saturationdeduction.index') }}",
                    data: {
                        "search": query,
