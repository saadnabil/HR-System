<div class="modal fade" id="delete-{{ $allowanceoption->id }}" abindex="-1" aria-hidden="true">
    <div class="modal-dialog confirmS1 ">
        <form class="content" method="post" action="{{ route("allowanceoption.destroy",$allowanceoption) }}">
            @csrf
            @method("delete")
