    ...
    <div class="addContractPage">
        <div class="pageS1">
          ...
          <a href="{{ route('contract-templates.index') }}">
            ...
            <form action="{{ route('contract-templates.store') }}" class="formS1 inputsS1"  method="post">
                @csrf
                <div class='sectionS2'>
                    <div class='content p-4'>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="inputS1">
                                    <input type="text" name="name" id="" placeholder='' value="{{ old('name') }}">
                                </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="inputS1">
                                    ...
                                    <input type="text"  name="date" value="{{ old('date' , Carbon\Carbon::now()->format('d/m/Y'))  }}" id="date" placeholder="Enter Date"
                ...
                <div class='sectionS2'>
                    <div class="head withBorder flex align between mb-4">
                        ...
                        <div class="flex align gap-2">
                            <button class='buttonS2  withBorder' type="button">
                    ...
                    <div class='content'>
                        ...
                        <textarea name="template" id="editor">{{ old('template') }}</textarea>
