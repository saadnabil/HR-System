...
<div class="modal fade" id="delete-{{ $performancefactor->id }}" abindex="-1" aria-hidden="true">
    <div class="modal-dialog confirmS1 ">
        <div class="content">
            <form class="content" method="post" action="{{ route("PerformanceFactor.destroy",$performancefactor) }}">
                @csrf
                @method("delete")
