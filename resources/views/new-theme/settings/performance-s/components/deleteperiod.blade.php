...
<div class="modal fade" id="delete-{{ $performanceperiod->id }}" abindex="-1" aria-hidden="true">
    <div class="modal-dialog confirmS1 ">
        <div class="content">
            <form class="content" method="post" action="{{ route("PerformancePeriod.destroy",$performanceperiod) }}">
                @csrf
                @method("delete")
