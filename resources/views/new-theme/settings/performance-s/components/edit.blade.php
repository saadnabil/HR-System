<div class="modal fade customeModal" id="editperformancefactor-{{ $performancefactor->id }}" tabindex="-1"
    aria-labelledby="addNewperformancefactorLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                <form class="formS1" method="post" action="{{ route('PerformanceFactor.update', $performancefactor) }}">
                    @csrf
                    @method('put')
                    <div class="sectionS2">
                        <div class="head withBorder flex align between">
                            <h3 class='small'>@lang('Edit PerformanceFactors')</h3>
                        ...
                        <div class="content">
                            <div class="">
                                ...
                                <div class="inputS1">
                                    <input {{ old('name') }} name="name" type="text" value="{{ $performancefactor->name }}" 
                            ...
                            <div class="">
                                ...
                                <div class="inputS1">
                                    <input {{ old('name_ar') }} name="name_ar" type="text" value="{{ $performancefactor->name_ar }}" 
                                ...
                                <div class="inputS1">
                                    <select name="performance_period_id">
                                        @foreach ($performanceperiods as $performanceperiod)
                                            <option value="{{ $performanceperiod->id }}" {{ $performanceperiod->id == $performancefactor->performance_period_id ? 'selected' : '' }}>
