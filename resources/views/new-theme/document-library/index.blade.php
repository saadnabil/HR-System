                    ...
                    <div class='datePickerContainer'>
                        <div class='datePicker'>
                            ...
                            <div class="inputS1">
                                ...
                                <input id="start_date" style="width: 225px;" type="text" value="" placeholder="{{__("Set The Time")}}"
                        ...
                        <div class="datePicker">
                            ...
                            <div class="inputS1">
                                <img src="/new-theme/icons/date.svg" class="iconImg" />
                                <input id="end_date" style="width: 225px;" type="text" value="" placeholder="{{__("Set The Time")}}"
                                    name="daterange" class="datePickerBasic" autocomplete="off" />
                            </div>
                        </div>
                    </div>
