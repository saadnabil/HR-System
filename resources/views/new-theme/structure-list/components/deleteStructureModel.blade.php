<div class="modal fade" id="delete-{{ $structureList->id }}" abindex="-1" aria-hidden="true">
    <div class="modal-dialog confirmS1 ">
        <form class="content" method="post" action="{{ route("companystructure.destroy",$structureList) }}">
            @csrf
            @method("delete")
