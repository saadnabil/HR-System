...
@push('styles')
    <link rel="stylesheet" href="{{ asset('new-theme/styles/assets.css') }}" />
@endpush
@section('content')
        ...
        <div class="pageS1">
            ...
            <div class='sectionS2'>
                <div class="head withBorder flex align between">
                    <h3 class='small'>{{ __('all Assets') }}</h3>
                    <div class='flex flex-wrap align gap-3'>
                        ...
                        @can('Assets-Export')
                            <a class='buttonS2 withBorder' href="{{ route('assets.export') }}">
                        ...
                        @can('Assets-Create')
                            <a href="{{ route('account-assets.create') }}">
                    ...
                    <div class='datePickerContainer'>
                        <div class='selectWithIcon'>
                            <div class="inputS1 svg-start  selectMonth">
                                <img src="/new-theme/icons/labtob.svg" class="iconImg" />
                                <select id="type">
                ...
                <div class="tableS1 scroll trPointer">
                    <table>
                        ...
                        <tbody>
                            @include('new-theme.assets.assets')
                        </tbody>
                    </table>
                </div>
            </div>
            ...
            <div class="paginationS1 paginater flex gap-4 align">
                @include('new-theme.assets.paginate')
            </div>
...
@push('script')
    <script>
        $(document).ready(function() {
            function fetch_data() {
                $.ajax({
                    url: "{{ route('account-assets.index') }}",
                    data: {
                        "search": $('#search').val(),
                        "type": $('#type').val(),
                    },
