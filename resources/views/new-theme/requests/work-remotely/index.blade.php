        ...
        <div class="pageS1">
            ...
            <div class='sectionS2'>
                <div class="head withBorder flex align between">
                    <h3 class='small'>{{ __('All Requests') }}</h3>
                    <div class='flex align gap-3'>
                        @can('WorkFromHome-Print')
                        ...
                        @can('WorkFromHome-Create')
                            <a href="{{ route('work-from-home.create') }}">
                    ...
                    <div class='datePickerContainer'>
                        <div class='datePicker'>
                            ...
                            <div class="inputS1 noHeight">
                                ...
                                <input style="width: 225px;" id="start_date" type="text" value="" id="start_date"
                        ...
                        <div class='datePicker '>
                            ...
                            <div class="inputS1 noHeight">
                                <img src="/new-theme/icons/date.svg" class="iconImg" />
                                <input style="width: 225px;" id="end_date" type="text" value="" id="end_date"
                ...
                <div class="tableS1 scroll trPointer">
                    <table>
                        ...
                        <tbody>
                            ...
                            @include('new-theme.requests.work-remotely.requests')
            ...
            <div class="paginater paginationS1 flex gap-4 align">
                @include('new-theme.requests.work-remotely.paginate')
            </div>
...
@push('script')
    ...
    @include("new-theme.components.export_print",[
        'export_url' => route('work-from-home.export'),
        'print_url' => route('work-from-home.print'),
    ])
    <script>
