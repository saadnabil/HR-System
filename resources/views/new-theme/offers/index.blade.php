        ...
        <div class="pageS1">
            ...
            <div class='sectionS2'>
                <div class="head flex align between">
                    <h3 class='small'>@lang('All Offers')</h3>
                            ...
                            <div class='datePickerContainer'>
                                <div class='datePicker'>
                                    ...
                                    <div class="inputS1">
                                        ...
                                        <input id="date-range" style="width: 225px;" value="{{ now()->format('d/m/Y') }}"
                                            type="text" value="" placeholder="Set The Time" name="datepicker"
            ...
            <div class="offers">
                <div class="row gx-5 gy-4 offers-data">
                    @include('new-theme.offers.offers-data')
                </div>
            </div>
...
@push('script')
    <script>
        $(document).ready(function() {
            function fetch_data() {
                let dataRanges = $('#date-range').val().split(" to ");
                let fromDate = dataRanges[0];
                let toDate = dataRanges[1];
