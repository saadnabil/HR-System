    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                {{ Form::select('department', $departments, null, ['class' => 'form-control ', 'required' => 'required', 'id' => 'department_id']) }}
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                {{ Form::label('designation', __('Designation'), ['class' => 'form-control-label']) }}
                <select class="form-control select2-multiple" id="designation_id" name="designation"
