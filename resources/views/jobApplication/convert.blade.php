            ...
            <div class="card card-fluid">
                ...
                <div class="card-body ">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            {!! Form::label('email', __('Email'),['class' => 'd-flex align-items-center fs-6 fw-semibold mb-2']) !!}<span class="text-danger pl-1">*</span>
                            {!! Form::email('email',old('email'), ['class' => 'form-control','required' => 'required']) !!}
                        </div>
                        <div class="form-group col-md-6">
                            {!! Form::label('password', __('Password'),['class' => 'd-flex align-items-center fs-6 fw-semibold mb-2']) !!}<span class="text-danger pl-1">*</span>
            ...
            <div class="card card-fluid">
                ...
                <div class="card-body employee-detail-create-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-12 ">
                            {!! Form::label('company_doj', __('Company Date Of Joining'),['class' => 'd-flex align-items-center fs-6 fw-semibold mb-2']) !!}
