                    ...
                    <div class="table-responsive">
                        ...
                        <thead>
                            ...
                            @foreach ($archive_application as $application)
                                <tr>
                                    <td><a class="" href="{{ route('job-application.show',\($application->id)) }}">  {{$application->name}}</a></td>
                                    ...
                                    <td>
                                        @can('Show Job Application')
                                            <a class="edit-icon btn btn-success" data-toggle="tooltip" data-title="{{__('Details')}}" href="{{ route('job-application.show',\($application->id)) }}"> <i class="fa fa-eye"></i></a>
                                        @endcan
                                    </td>
                                </tr>
                            @endforeach
