                                    ...
                                    <div class="row px-3">
                                        ...
                                        @foreach($allowances as $allownace)
                                            <div class="col-md-12 form-group">
                                                {!! Form::label('title', $allownace->title,['class' => 'd-flex align-items-center fs-6 fw-semibold mb-2']) !!}
                                ...
                                <div class="card bg-none mb-0">
                                    <div class="row px-3">
                                        ...
                                        @foreach($commissions as $commission)
                                            <div class="col-md-12 form-group">
                                                {!! Form::label('title', $commission->title,['class' => 'd-flex align-items-center fs-6 fw-semibold mb-2']) !!}
                                ...
                                <div class="card bg-none mb-0">
                                    <div class="row px-3">
                                        ...
                                        @foreach($loans as $loan)
                                            <div class="col-md-12 form-group">
                                                {!! Form::label('title', $loan->title,['class' => 'd-flex align-items-center fs-6 fw-semibold mb-2']) !!}
                                ...
                                <div class="card bg-none mb-0">
                                    <div class="row px-3">
                                        ...
                                        @foreach($saturation_deductions as $deduction)
                                            <div class="col-md-12 form-group">
                                                {!! Form::label('title', $deduction->title,['class' => 'd-flex align-items-center fs-6 fw-semibold mb-2']) !!}
                                ...
                                <div class="card bg-none mb-0">
                                    <div class="row px-3">
                                        ...
                                        @foreach($other_payments as $payment)
                                            <div class="col-md-12 form-group">
                                                {!! Form::label('title', $payment->title,['class' => 'd-flex align-items-center fs-6 fw-semibold mb-2']) !!}
                                    ...
                                    <div class="row px-3">
                                        ...
                                        @foreach($overtimes as $overtime)
                                            <div class="col-md-6 form-group">
                                                {!! Form::label('rate', $overtime->title.' '.__('Rate'),['class' => 'd-flex align-items-center fs-6 fw-semibold mb-2']) !!}
                                                {!! Form::text('rate[]', $overtime->rate, ['class' => 'form-control']) !!}
                                                {!! Form::hidden('rate_id[]', $overtime->id, ['class' => 'form-control']) !!}
                                            </div>
                                            <div class="col-md-6 form-group">
                                                {!! Form::label('hours',$overtime->title.' '.__('Hours'),['class' => 'd-flex align-items-center fs-6 fw-semibold mb-2']) !!}
