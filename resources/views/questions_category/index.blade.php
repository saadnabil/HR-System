    ...
    <div class="all-button-box row d-flex justify-content-end">
        @can('Create Employee')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="#" data-url="{{ route('question_category.create') }}" class="btn btn-primary" data-ajax-popup="true" data-title="{{__('Create evaluation question')}}">
    ...
    <div class="container d-flex flex-column flex-lg-row" id="kt_docs_content_container">
        ...
        <div class="card card-docs flex-row-fluid mb-2">
            ...
            <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                ...
                <div class="py-0">
                    <!--begin::Heading-->
                    <h1 class="fw-bold mb-5">{{__('Evaluation question categories')}}</h1>

                    {{--  <div class="d-flex align-items-center gap-2 gap-lg-3">
                        <!--begin::Primary button-->

                        <a href="#" data-url="{{ route('question_category.create') }}" data-ajax-popup="true"
                                    ...
                                    <table class="table align-middle border rounded table-row-dashed fs-6 g-5" id="kt_datatable_example">
                                        <thead>
                                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase">
                                                <th class="min-w-100px">{{ __('Evaluation category') }}</th>
                                        ...
                                        <tbody class="fw-semibold text-gray-600">
                                            ...
                                            <tr>
                                                <td>{{ app()->isLocale('en') ? $cat->title : $cat->title_ar }}</td>
                                                <td class="Action text-center">
                                                    <span>
                                                        <a href="{{ route('question_category.show', $cat->id) }}" class="btn btn-icon btn-active-light-success w-30px h-30px" data-url="{{ route('question_category.show', $cat->id) }}" data-size="lg" data-ajax-popup="true" data-title="{{ __('Show') }}" data-toggle="tooltip" data-original-title="{{__('Show')}}"><i class="fa fa-list"></i></a>
                                                        {{--  <a href="#" class="btn btn-icon btn-active-light-success w-30px h-30px" data-url="{{ route('question_category.edit', $cat->id) }}" data-size="lg" data-ajax-popup="true" data-title="{{ __('Edit') }}" data-toggle="tooltip" data-original-title="{{__('Edit')}}"><i class="fa fa-edit"></i></a>  --}}
                                                        ...
                                                        {!! Form::open(['method' => 'DELETE', 'route' => ['question_category.destroy', $cat->id],'id'=>'delete-form-'.$cat->id]) !!}
                                                        {!! Form::close() !!}  --}}
                                                    </span>
                                                </td>
                                            </tr>
