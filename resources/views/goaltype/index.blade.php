    ...
    <div class="container d-flex flex-column flex-lg-row" id="kt_docs_content_container">
        ...
        <div class="card card-docs flex-row-fluid mb-2">
            ...
            <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                ...
                <div class="py-0">
                    <!--begin::Heading-->
                    <h1 class="fw-bold mb-5">{{__('Manage Goal Type')}}</h1>
                                            ...
                                            @foreach($goaltypes as $goaltype)
                                                <tr>
                                                    ...
                                                    <td class="Action text-center">
                                                        <span>
                                                            @can('Edit Goal Type')
                                                                <a href="#" class="btn btn-icon btn-active-light-success w-30px h-30px" data-url="{{ route('goaltype.edit', $goaltype->id) }}" data-size="lg" data-ajax-popup="true" data-title="{{ __('Edit Goal Type') }}" data-toggle="tooltip" data-original-title="{{__('Edit')}}"><i class="fa fa-edit"></i></a>
                                                            @endcan
            ...
            $('.confirm-delete').click(function(e){
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        document.getElementById('delete-form-{{$goaltype->id}}').submit()
                    }
                });
                return false;
            });
