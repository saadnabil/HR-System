    ...
    <div class="container d-flex flex-column flex-lg-row" id="kt_docs_content_container">
        ...
        <div class="card card-docs flex-row-fluid mb-2">
            ...
            <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                ...
                <div class="py-0">
                    <!--begin::Heading-->
                    <h1 class="fw-bold mb-5">{{ __('Manage Timesheet') }}</h1>
                    ...
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                                ...
                                <div class="px-7 py-5">
                                    {{ Form::open(['route' => ['timesheet.index'], 'method' => 'get', 'id' => 'timesheet_filter']) }}
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <a href="{{ route('timesheet.index') }}" type="reset" class="btn btn-sm btn-light btn-active-light-primary me-2">{{ __('Reset') }}</a>
                                            <button  onclick="document.getElementById('timesheet_filter').submit(); return false;" class="btn btn-sm btn-primary" data-kt-menu-dismiss="true">{{ __('apply') }}</button>
                                        </div>
                                        <!--end::Actions-->
                                    {{ Form::close() }}
                                </div>
                        ...
                        <a href="#" data-url="{{ route('timesheet.create') }}" data-ajax-popup="true"
                                            ...
                                            @foreach($timeSheets as $timeSheet)
                                                <tr>
                                                    ...
                                                    <td class="Action text-center">
                                                        <span>
                                                            @can('Edit TimeSheet')
                                                                <a href="#" class="btn btn-icon btn-active-light-success w-30px h-30px" data-url="{{ route('timesheet.edit', $timeSheet->id) }}" data-size="lg" data-ajax-popup="true" data-title="{{ __('Edit Timesheet') }}" data-toggle="tooltip" data-original-title="{{__('Edit')}}"><i class="fa fa-edit"></i></a>
                                                            @endcan
