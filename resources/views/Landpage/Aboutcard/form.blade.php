...
<div class="card shadow-sm">
    <div class="card-body">
        ...
        <form method="POST" action="{{ $case == 'update' ? route('landpage.landaboutcard.update', ['id' => $row->id]) : route('landpage.landaboutcard.store') }}" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="row">
                ...
                <div class="col-md-12" >
                    <div class="mb-10">
                        <div class="rounded  ">
                            <label for="image" class="form-label">{{ __('landpage.Image') }} </label>
