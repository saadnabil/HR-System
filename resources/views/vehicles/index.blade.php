    ...
    <div class="container d-flex flex-column flex-lg-row" id="kt_docs_content_container">
        ...
        <div class="card card-docs flex-row-fluid mb-2">
            ...
            <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                ...
                <div class="py-0">
                    <!--begin::Heading-->
                    <h1 class="fw-bold mb-5">  {{__('vehicles list')}} </h1>

                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        <!--begin::Primary button-->
                        @can('Create Travel')
                        <a href="#" data-url="{{ route('vehicle.create') }}" data-ajax-popup="true"
                                    ...
                                    <table class="table align-middle border rounded table-row-dashed fs-6 g-5" id="kt_datatable_example">
                                        <thead>
                                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase">
                                                <th class="min-w-100px">{{__('vehicle_type')}}</th>
                                                <th class="min-w-100px">{{__('model')}}</th>
                                                <th class="min-w-100px">{{__('registration_date')}}</th>
                                                <th class="min-w-100px">{{__('insurance_date')}}</th>
                                                <th class="min-w-100px">{{__('check_date')}}</th>
                                                ...
                                                <tr>
                                                    ...
                                                    @if(Gate::check('Edit Travel') || Gate::check('Delete Travel'))
                                                        <td class="Action text-center">
                                                            <span>
                                                                @can('Edit Training')
                                                                    <a href="#" class="btn btn-icon btn-active-light-success w-30px h-30px" data-url="{{ URL::to('vehicle/'.$vehicle->id.'/edit') }}" data-size="lg" data-ajax-popup="true" data-title="{{ __('Edit') }}" data-toggle="tooltip" data-original-title="{{__('Edit')}}"><i class="fa fa-edit"></i></a>
                                                                @endcan
