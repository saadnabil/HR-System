        ...
        <div class="app-container container-fluid d-flex align-items-stretch justify-content-between">
            ...
            <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                <a href="{{ route('home') }}" class="d-lg-none">
                    <img alt="Logo"
                        src="{{ auth()->user()->avatar ? $profile . '/' . auth()->user()->avatar : $profile . '/avatar.png' }}"
                        class="h-30px">
                </a>
            </div>
            <!--end::Mobile logo-->
            ...
            <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
                ...
                <div class="app-navbar flex-shrink-0">
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-6">
                                        <a href="{{ route('payslip.index') }}"
                                            ...
                                            <!--end::Svg Icon-->
                                            <span
                                                class="fs-5 fw-semibold text-gray-800 mb-0">{{ __('Payslip List') }}</span>
                                        </a>
                                    </div>
                                    <!--end:Item-->
                                    <!--begin:Item-->
                                    <div class="col-6">
                                        <a href="{{ route('user.index') }}"
                                            ...
                                            <!--end::Svg Icon-->
                                            <span
                                                class="fs-5 fw-semibold text-gray-800 mb-0">{{ __('User') }}</span>
                                        </a>
                                    </div>
                                    <!--end:Item-->
                                    <!--begin:Item-->
                                    <div class="col-6">
                                        <a href="{{ route('report.monthly.attendance') }}"
                                            ...
                                            <!--end::Svg Icon-->
                                            <span
                                                class="fs-5 fw-semibold text-gray-800 mb-0">{{ __('Report') }}</span>
                                        </a>
                                    </div>
                                    <!--end:Item-->
                                    <!--begin:Item-->
                                    <div class="col-6">
                                        <a href="{{ route('employee.index') }}"
                                            ...
                                            <!--end::Svg Icon-->
                                            <span
                                                class="fs-5 fw-semibold text-gray-800 mb-0">{{ __('Employee List') }}</span>
                                        </a>
                                    </div>
                                    <!--end:Item-->
                                </div>
                    ...
                    <div class="app-navbar-item ms-1 ms-lg-3">
                        <!--begin::Menu- wrapper-->
                        <div class="btn btn-icon btn-custom bell-notification btn-icon-muted btn-active-light btn-active-color-primary w-35px h-35px w-md-40px h-md-40px  menu-dropdown"
                            data-kt-menu-trigger="click" data-kt-menu-attach="parent"
                            data-kt-menu-placement="bottom-end">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen022.svg-->
                            <span class="svg-icon svg-icon-1" style="position:relative;">
                                @php
                                    $notification_unread_count = App\Models\Notification::where(
                                        [
                                ...
                                @if ($notification_unread_count > 0)
                                    <span class="notification-count-span"
                                        style="font-weight:bold;font-size:9px;position:absolute;top:-20px;right:-20px;display:inline-block;width:25px;height:25px;background:#009EF7;color:#fff;text-align:center;line-height:25px;border-radius:50%;">{{ $notification_unread_count }}</span>
                                @endif
                                <i style="font-size:15px;" class="fa fa-bell"></i>
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px "
                            data-kt-menu="true"
                            style="z-index: 105; position: fixed; inset: 0px 0px auto auto; margin: 0px; transform: translate(-229px, -364px);"
                            data-popper-placement="bottom-end">
                            <!--begin::Heading-->
                            <div class="d-flex flex-column bgi-no-repeat rounded-top"
                                style="background-image:url('{{ url('admin/assets/media/misc/pattern-1.jpg') }}')">
                                <!--begin::Title-->
                                    ...
                                    <div class="scroll-y mh-325px my-5 px-8">
                                        ...
                                        @foreach ($notifications as $notification)
                                            ...
                                            <div class="d-flex flex-stack py-4"
                                                style="margin-bottom:8px;border-radius: 5px; padding:5px;background-color: {{ $notification->read == 0 ? '#f2f2f2' : '' }}">
                                                <!--begin::Section-->
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <!--begin::Title-->
                                                    <div class="mb-0 me-2">
                                                        <a href="{{ $notification->redirect_url ? url($notification->redirect_url) : '#' }}"
                                                            class="fs-6 text-gray-800 text-hover-primary fw-bold">{{ app()->isLocale('en') ? $notification->title : $notification->title_ar }}</a>
                                                        <div class="text-gray-400 fs-7">
                                                            {{ app()->isLocale('en') ? $notification->body : $notification->body_ar }}
                                                        </div>
                                                    </div>
                                                    <!--end::Title-->
                                                </div>
                                                ...
                                                <!--begin::Label-->
                                                <span
                                                    class="badge badge-light fs-8">{{ \Carbon\Carbon::createFromTimeStamp(strtotime($notification->created_at))->diffForHumans() }}</span>
                                                <!--end::Label-->
                                            </div>
                                            <!--end::Item-->
                                        @endforeach
                    ...
                    <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                        ...
                        <div class="cursor-pointer symbol symbol-35px symbol-md-40px" data-kt-menu-trigger="click"
                            ...
                            <img src="{{ auth()->user()->avatar ? $profile . '/' . auth()->user()->avatar : $profile . '/avatar.png' }}"
                                alt="user">
                        </div>
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                                ...
                                <div class="menu-content d-flex align-items-center px-3">
                                    ...
                                    <div class="d-flex flex-column">
                                        <div class="fw-bold d-flex align-items-center fs-5">{{ auth()->user()->name }}
                                            <span
                                                class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">{{ auth()->user()->type }}</span>
                                        </div>
                                        <a href="#"
                            ...
                            <div class="menu-item px-5">
                                <a href="{{ route('profile') }}" class="menu-link px-5">{{ __('My profile') }}</a>
                            </div>
                            <!--end::Menu item-->
                            ...
                            <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                ...
                                <a href="#" class="menu-link px-5">
                                    <span class="menu-title position-relative">{{ __('Language') }}
                                        <span class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0"> {{ Str::upper($currantLang) }}
                                            <img class="w-15px h-15px rounded-1 ms-2" src="{{asset('admin/assets/media/flags/flag.png')}}" alt="">
                                        </span>
                                    </span>
                                </a>
                                <!--begin::Menu sub-->
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="{{ route('change.language', $language) }}"
                                                ...
                                                <span class="symbol symbol-20px me-4">
                                                    <img class="rounded-1"
                                                        src="{{ asset('admin/assets/media/flags/flag.png') }}"
                                                        alt="">
                                                </span>{{ Str::upper($language) }}</a>
                                        </div>
                                        <!--end::Menu item-->
                                    @endforeach
                                </div>
                            ...
                            <div class="menu-item px-5 my-1">
                                <a href="{{ route('account_setting') }}"
                                    class="menu-link px-5">{{ __('Account Setting') }} </a>
                            </div>
                            <!--end::Menu item-->
    ...
    @if (auth()->user()->type == 'employee' && $companyslate && auth()->user()->company_slate_readed != 1)
        <div class="row">
            <div class="modal bd-example-modal-lg" id="exampleModal" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog" role="document">
                    <div style="height:500px;" class="modal-content">
                        ...
                        <div class="modal-footer">
                            <a style="color:#fff;" target="__blank" class="col-md-4 btn btn-success"
                                href="{{ asset(Storage::url($companyslate['file' . $lang])) }}"> <i class="fa fa-eye"
                                    aria-hidden="true"></i> {{ __('Preview') }}</a>
                            <a style="color:#fff;" class="col-md-4 btn btn-info"
                                href="{{ asset(Storage::url($companyslate['file' . $lang])) }}" download> <i
                                    class="fa fa-download" aria-hidden="true"></i> {{ __('Download') }}</a>

                            {!! Form::open(['method' => 'POST', 'class' => 'col-md-4', 'route' => ['companyslate.accept']]) !!}
                            <button style="width:100%;" type="submit" class="btn btn-primary"><i
                                    class="fa fa-check" aria-hidden="true"></i> {{ __('Accept') }}</button>
                            {!! Form::close() !!}
