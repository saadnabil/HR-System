        ...
        <div class="login-inner-contain">
            ...
            <div class="login-form">
                ...
                <div class="form-group">
                    {{Form::label('email',__('E-Mail Address'),['class' => 'd-flex align-items-center fs-6 fw-semibold mb-2'])}}
                ...
                <div class="form-group">
                    {{Form::label('password_confirmation',__('Password Confirmation'),['class' => 'd-flex align-items-center fs-6 fw-semibold mb-2'])}}
