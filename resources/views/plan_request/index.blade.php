        ...
        <div class="container d-flex flex-column flex-lg-row" id="kt_docs_content_container">
            ...
            <div class="card card-docs flex-row-fluid mb-2">
                ...
                <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                    ...
                    <div class="py-0">
                        <!--begin::Heading-->
                        <h1 class="fw-bold mb-5">{{ __('Manage Plan Request') }}</h1>
                        <!--end::Heading-->
                                        ...
                                        <table class="table align-middle border rounded table-row-dashed fs-6 g-5" id="kt_datatable_example">
                                            <thead>
                                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase">
                                                    ...
                                                    <th class="min-w-100px"> {{ __('Plan Name') }}</th>
                                                ...
                                                @foreach($plan_requests as $prequest)
                                                    <tr>
                                                        ...
                                                        <td class="Action text-center">
                                                            <span>
                                                                <a href="{{ route('plan_request.update', $prequest->id) }}" class="btn btn-icon btn-active-light-success w-30px h-30px"><i class="fa fa-check"></i></a>
                                                                <button type="button" class="btn btn-icon confirm-delete btn-active-light-danger w-30px h-30px"><i class="fa fa-times-o"></i></button>
            ...
            $('.confirm-delete').click(function(e){
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        document.getElementById('delete-form-{{$prequest->id}}').submit()
                    }
                });
                return false;
            });
