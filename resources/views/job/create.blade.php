            ...
            <div class="card card-fluid">
                <div class="card-body ">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            {!! Form::label('category', __('Job Category'),['class' => 'd-flex align-items-center fs-6 fw-semibold mb-2']) !!}
                            {{ Form::select('category', $categories,null, array('class' => 'form-control ','required'=>'required')) }}
                        </div>

                        <div class="form-group col-md-6">
                            {!! Form::label('position', __('Positions'),['class' => 'd-flex align-items-center fs-6 fw-semibold mb-2']) !!}
        ...
        <div class="col-md-6">
            <div class="card card-fluid">
                <div class="card-body ">
                    <div class="row">
                        <div class="form-group col-md-12">
                            {!! Form::label('sescription', __('Job Description'),['class' => 'd-flex align-items-center fs-6 fw-semibold mb-2']) !!}
        ...
        <div class="col-md-6">
            <div class="card card-fluid">
                <div class="card-body ">
                    <div class="row">
                        <div class="form-group col-md-12">
                            {!! Form::label('requirement', __('Job Requirement'),['class' => 'd-flex align-items-center fs-6 fw-semibold mb-2']) !!}
