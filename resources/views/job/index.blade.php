    ...
    <div class="container d-flex flex-column flex-lg-row" id="kt_docs_content_container">
        ...
        <div class="card card-docs flex-row-fluid mb-2">
            ...
            <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                ...
                <div class="py-0">
                    <!--begin::Heading-->
                    <h1 class="fw-bold mb-5">{{__('Manage Job')}}</h1>

                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        <!--begin::Primary button-->
                        @can('Create Job')
                        <a href="#" data-url="{{ route('job.create') }}" data-ajax-popup="true"
                                                    ...
                                                    @if( Gate::check('Edit Job') ||Gate::check('Delete Job') || Gate::check('Show Job'))
                                                        <td class="Action text-center">
                                                            <span>
                                                                ...
                                                                <a href="{{ route('job.requirement',[$job->code,!empty($job)?$job->createdBy->lang:'en']) }}" class="btn btn-icon btn-active-light-info w-30px h-30px copy_link" data-toggle="tooltip" data-original-title="{{__('Click to copy')}}"><i class="fa fa-link"></i></a>
                                                                @endif

                                                                @can('Show Job')
                                                                    <a href="#" data-url="{{ route('job.show',$job->id) }}" data-size="lg" data-ajax-popup="true" data-title="{{__('View Detail')}}" class="btn btn-icon btn-active-light-info w-30px h-30px" data-toggle="tooltip" data-original-title="{{__('View Detail')}}"><i class="fa fa-eye"></i></a>
                                                                @endcan

                                                                @can('Edit Job')
                                                                    <a href="#" class="btn btn-icon btn-active-light-success w-30px h-30px" data-url="{{ route('job.edit', $job->id) }}" data-size="lg" data-ajax-popup="true" data-title="{{ __('Edit') }}" data-toggle="tooltip" data-original-title="{{__('Edit')}}"><i class="fa fa-edit"></i></a>
                                                                @endcan
