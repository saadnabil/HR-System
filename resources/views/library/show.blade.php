                                                        ...
                                                        <div class="ibox">
                                                            @can('Create Document')
                                                                <div class="text-center">
                                                                    <a id="btn-anchor" href="#" data-url="{{ route('company-document-upload.create',['id' => $category->id]) }}" data-size="lg" data-ajax-popup="true" data-title="" class="btn btn-info mb-4" data-toggle="tooltip" data-original-title=""> {{__('Add_document')}} </a>
                                                                </div>
                                                            @endcan
                                                                            ...
                                                                            @foreach($category->documents as $document)
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="Action text-center">
                                                                                        <span>
                                                                                            <a href="#" class="btn btn-icon btn-active-light-success w-30px h-30px" data-url="{{ route('company-document-upload.edit',  [$document->id , 'id' => $category->id])}}" data-size="lg" data-ajax-popup="true" data-title="{{__('Edit Document')}}" data-toggle="tooltip" data-original-title="{{__('Edit')}}"><i class="fa fa-edit"></i></a>
