        ...
        <div class="container d-flex flex-column flex-lg-row" id="kt_docs_content_container">
            ...
            <div class="card card-docs flex-row-fluid mb-2">
                ...
                <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                    ...
                    <div class="py-0">
                        <!--begin::Heading-->
                        <h1 class="fw-bold mb-5">{{ __('Folders') }}</h1>

                        <div class="d-flex align-items-center gap-2 gap-lg-3">
                            <!--begin::Primary button-->
                                    <a href="#"
                                        data-url="{{ route('library.create')}}"
                                        data-ajax-popup="true" data-title="{{ __('Create folder') }}"
                                        class="btn btn-sm fw-bold btn-primary">{{ __('Create folder') }}
                                    </a>
                            <!--end::Primary button-->
                        </div>
                                                ...
                                                @foreach ($categories as $category)
                                                    <tr>
                                                        ...
                                                        <td class="text-right action-btns">
                                                                <span>
                                                                    <a href="{{ route('library.show', $category->id) }}" class="btn btn-icon btn-active-light-success w-30px h-30px" data-url="" data-size="lg" data-ajax-popup="true" data-title="{{ __('View') }}" data-toggle="tooltip" data-original-title="{{__('View')}}"><i class="fa fa-eye"></i></a>
                                                                    <a href="#" class="btn btn-icon btn-active-light-success w-30px h-30px" data-url="{{ route('library.edit', $category->id) }}" data-size="lg" data-ajax-popup="true" data-title="{{ __('Edit') }}" data-toggle="tooltip" data-original-title="{{__('Edit')}}"><i class="fa fa-edit"></i></a>
                                                                    ...
                                                                    {!! Form::open(['method' => 'DELETE', 'route' => ['library.destroy', $category->id],'id'=>'delete-form-'.$category->id]) !!}
                                                                    {!! Form::close() !!}
                                                                </span>
                                                        </td>
