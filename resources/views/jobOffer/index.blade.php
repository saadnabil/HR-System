    ...
    <div class="container d-flex flex-column flex-lg-row" id="kt_docs_content_container">
        ...
        <div class="card card-docs flex-row-fluid mb-2">
            ...
            <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                ...
                <div class="py-0">
                    <!--begin::Heading-->
                    <h1 class="fw-bold mb-5">{{__('Job offers')}}</h1>

                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        <!--begin::Primary button-->

                        <a href="#" data-url="{{ route('job-offers.create') }}" data-ajax-popup="true"
                                        ...
                                        <tbody class="fw-semibold text-gray-600">
                                            @foreach ($offers as $offer)
                                                <tr>
                                                    ...
                                                    <td>{{ \App\Models\User::find($offer->created_by)->name }}</td>
                                                    <td> <button  class="btn btn-success btn-sm copy-btn" data-link = "{{ route('vacancies.show' , encrypt($offer->id))  }}"> {{ __('Copy the submission link') }} <i style="padding-right=5px;" class="fa fa-copy"></i> </button></td>
                                                    <td class="Action text-center">
                                                        <span>
                                                            <a class="btn btn-icon btn-active-light-success w-30px h-30px" href="{{ route('job-offers.show', $offer->id) }}"  title="{{ __('View all requests') }}"  ><i class="fa fa-list"></i></a>
                                                                <a href="#" class="btn btn-icon btn-active-light-success w-30px h-30px" data-url="{{ route('job-offers.edit', $offer->id) }}" data-size="lg" data-ajax-popup="true" data-title="{{ __('Edit') }}" data-toggle="tooltip" data-original-title="{{__('Edit')}}"><i class="fa fa-edit"></i></a>
                                                                ...
                                                                {!! Form::open(['method' => 'DELETE', 'route' => ['job-offers.destroy', $offer->id],'id'=>'delete-form-'.$offer->id]) !!}
                                                                {!! Form::close() !!}
                                                        </span>
                                                    </td>
                                                </tr>
